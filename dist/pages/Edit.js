...
export function NoteEdit({ id, onNavigate, allowRichText = false, }) {
    ...
    return (_jsxs(Page, { title: isNew ? 'New Note' : 'Edit Note', actions: _jsxs(Button, { variant: "secondary", onClick: handleCancel, children: [_jsx(ArrowLeft, { size: 16, className: "mr-2" }), "Cancel"] }), children: [saveError && (_jsx(Alert, { variant: "error", title: "Error saving note", children: saveError.message })), _jsx(Card, { children: _jsxs("form", { onSubmit: handleSubmit, className: "space-y-6 p-6", children: [_jsx(Input, { label: "Title", value: title, onChange: setTitle, placeholder: "Enter note title...", required: true, error: fieldErrors.title }), _jsx(TextArea, { label: "Content", value: content, onChange: setContent, placeholder: allowRichText
                                ? 'Write your note... (Markdown supported)'
                                : 'Write your note...', rows: 15 }), _jsxs("div", { className: "flex items-center justify-end gap-3 pt-6 mt-6 border-t border-gray-800", children: [_jsx(Button, { type: "button", variant: "secondary", onClick: handleCancel, children: "Cancel" }), _jsxs(Button, { type: "submit", variant: "primary", loading: saving, children: [_jsx(Save, { size: 16, className: "mr-2" }), isNew ? 'Create Note' : 'Save Changes'] })] })] }) })] }));
}
